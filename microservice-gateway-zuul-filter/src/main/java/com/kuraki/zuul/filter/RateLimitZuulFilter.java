...
public class RateLimitZuulFilter extends ZuulFilter {
    ...
    public int filterOrder() {
        /**
         * 这边的order一定要大于org.springframework.cloud.netflix.zuul.filters.pre.PreDecorationFilter
         * 的order，也就是要大于5。否则，RequestContext.getCurrentContext()里拿不到serviceId等数据。
         */
    ...
    public boolean shouldFilter() {
        // 限流开启的开关，开启限流返回true，关闭限流返回false
